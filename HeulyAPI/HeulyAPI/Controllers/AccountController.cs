...
namespace HeulyAPI.Controllers
{
    ...
    [EnableCors("AllowAll")]  // Aplica a política de CORS "AllowAll" a todo o controlador
    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordDto forgotPasswordDto)
        {
            ...
            if (user == null)
            {
                ...
                {
                    IsSuccess = false,
                    Message = "Se um usuário com esse e-mail existir, um e-mail de redefinição será enviado."
                });
            }
